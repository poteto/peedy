defmodule PeedyF.QueueTest do
  use ExUnit.Case
  alias PeedyF.{Queue, Watermark}
  ...
  test "perform watermarks a document", %{watermark: watermark} do
    ...
    document = Queue.perform(watermark: watermark, input_path: @sample_pdf_path, ephemeral?: true, callback: k)
